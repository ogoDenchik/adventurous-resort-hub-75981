      ...
      <div className="container relative">
        ...
        <ScrollAnimationWrapper animation="animate-fade-in opacity-100" delay={400}>
          <div className="text-center mt-10">
            <Link to="/gallery" className="btn-primary inline-flex items-center gap-2 hover-scale whitespace-nowrap flex-nowrap">
              <span className="whitespace-nowrap">View Full Gallery</span>
