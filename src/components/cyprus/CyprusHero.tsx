...
const CyprusHero: React.FC = () => {
  ...
  return (
    <section className="relative h-[85vh] min-h-[600px] flex items-center justify-center overflow-hidden pt-20">
      <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: 'url(/lovable-uploads/cyprus-hero-aerial.jpg)', backgroundPosition: 'center calc(50% + 100px)' }}>
