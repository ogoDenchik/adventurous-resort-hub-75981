        ...
        <section className="section-padding container">
          ...
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            <div className="grid grid-cols-2 gap-4 animate-fade-in animation-delay-500">
              <img src="/lovable-uploads/about-team-cars.jpg" alt="Team adventures" className="w-full h-[250px] object-cover rounded-xl shadow-lg" style={{objectPosition: 'center calc(100% - 100px)'}} />
